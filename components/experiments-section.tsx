...
export function ExperimentsSection() {
  return (
    <section id="experiments" className="py-24 md:py-36 bg-slate-950 border-t border-slate-800 text-white relative z-10">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
          <div>
            <span className="font-mono text-xs font-semibold uppercase tracking-widest text-orange-400 block mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="p-8 rounded-3xl bg-slate-900/80 border border-slate-800 space-y-4">
            <span className="font-mono text-xs text-orange-400">EXP-01</span>
          ...
          <div className="p-8 rounded-3xl bg-slate-900/80 border border-slate-800 space-y-4">
            <span className="font-mono text-xs text-orange-400">EXP-02</span>
